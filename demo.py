...
# client = Bing_Client(cookie="cookie.json", proxy="http://172.67.45.77:80")
...
async def main():
    ...
    async for text in client.ask_stream("请根据你获得的图像描述文本,利用你自身gpt4的能力推理文本中包含的商品信息,商品品牌,商品卖点,目标人群对象,并用正确的json字符串返回,中文回复,json示例:",image="./tmp/bg.jpeg", chat=chat,
                                    yield_search=False,
